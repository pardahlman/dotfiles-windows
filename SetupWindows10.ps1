...
$tweaks = @(
	...
	"DisableQuickAccess",           # "EnableQuickAccess",
...
# Disable Quick Access folder in Explorer
Function DisableQuickAccess {
	Write-Host "Disable Quick Access"
	Set-ItemProperty -Path HKCU:\SOFTWARE\Microsoft\Windows\CurrentVersion\Explorer -Name ShowFrequent -Type DWord -Value 0
}

# Disable Quick Access folder in Explorer
Function EnableQuickAccess {
	Write-Host "Enable Quick Access"
